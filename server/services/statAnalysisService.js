...
const statsAnalysisService = {
    ...
    getPlayerImprovementMetrics: (olderMatches, recentMatches, puuid) => {
      ...
      return {
        killDifference: (recentStats.averageKills - olderStats.averageKills).toFixed(2),
        ...
        goldDifference: (recentStats.averageGoldEarned - olderStats.averageGoldEarned).toFixed(2),
        damageDifference: (recentStats.averageDamageDealt - olderStats.averageDamageDealt).toFixed(2),
